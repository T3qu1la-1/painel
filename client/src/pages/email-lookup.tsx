...
export default function EmailLookup() {
  ...
  const handleGlobalSearch = (query: string) => {
    ...
    const searchInput = document.querySelector('[data-testid="input-email-query"]') as HTMLInputElement;
    if (searchInput) {
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-auto bg-gray-800 p-4 md:p-6">
          <div className="max-w-6xl mx-auto">
            <div className="mb-6">
              <h1 className="text-2xl font-bold text-gray-50 mb-2">Email Lookup</h1>
              <p className="text-gray-400">
                Analyze email addresses for breaches, validity, and associated information
              </p>
            </div>
