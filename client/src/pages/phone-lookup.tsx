...
export default function PhoneLookup() {
  ...
  const handleGlobalSearch = (query: string) => {
    ...
    const searchInput = document.querySelector('[data-testid="input-phone-query"]') as HTMLInputElement;
    if (searchInput) {
          ...
          <div className="max-w-6xl mx-auto">
            <div className="mb-6">
              ...
              <p className="text-gray-400" data-testid="page-description">
                Verify phone numbers and gather carrier and location information
              </p>
            </div>
