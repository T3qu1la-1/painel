...
export default function SocialMedia() {
  ...
  const handleGlobalSearch = (query: string) => {
    ...
    const searchInput = document.querySelector('[data-testid="input-social-query"]') as HTMLInputElement;
    if (searchInput) {
          ...
          <div className="max-w-6xl mx-auto">
            <div className="mb-6">
              ...
              <p className="text-gray-400" data-testid="page-description">
                Search for social media profiles across multiple platforms by username
              </p>
            </div>
